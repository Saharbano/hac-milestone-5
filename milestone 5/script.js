...
[nameInput, emailInput, phoneInput, addressInput, skillsInput, educationInput, experienceInput].forEach(function (input) {
...
var shareablelink = document.getElementById("shareble-link");
shareablelink.addEventListener("click", function () {
});
var downlodepdf = document.getElementById("downloadpdf");
downlodepdf.addEventListener("click", function () {
    window.print();
});
